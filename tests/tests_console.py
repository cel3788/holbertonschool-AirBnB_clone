class TestHBNBCommand(unittest.TestCase):
    ...
    def test_quit_present(self):
        with patch('sys.stdout', new=StringIO()) as f:
            ...
            self.assertEqual(f.getvalue().strip(), "Exits the program with formatting")

    def test_EOF_present(self):
        with patch('sys.stdout', new=StringIO()) as f:
            HBNBCommand().onecmd("help EOF")
            self.assertEqual(f.getvalue().strip(), "Exits the program without formatting")

    def test_help_present(self):
        with patch('sys.stdout', new=StringIO()) as f:
            HBNBCommand().onecmd("help help")
            self.assertEqual(f.getvalue().strip(), "Shows help for commands")
    ...
    def test_create_BaseModel_present(self):
        with patch('sys.stdout', new=StringIO()) as f:
            ...
            self.assertEqual(f.getvalue().strip(), "Creates a new instance of the specified class")
